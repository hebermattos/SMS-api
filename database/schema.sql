...
(
    ...
    RequestsPerMinute INTEGER NOT NULL DEFAULT 120 CHECK (RequestsPerMinute BETWEEN 1 AND 100000),
    SmsPerMinute INTEGER NOT NULL DEFAULT 10 CHECK (SmsPerMinute BETWEEN 1 AND 100000),
    OllamaRequestsPerMinute INTEGER NOT NULL DEFAULT 6 CHECK (OllamaRequestsPerMinute BETWEEN 1 AND 100000),
