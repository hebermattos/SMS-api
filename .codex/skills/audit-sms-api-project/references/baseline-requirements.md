# SMS API baseline requirements

Use this checklist when auditing the `sms-api` project. The user's current explicit instructions and applicable repository instruction files take precedence over this snapshot.
